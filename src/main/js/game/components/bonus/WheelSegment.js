  ...
  class Segment extends PIXI.Container {
    constructor(data) {
      ...
      if (this.type === 'outer') {
        ...
        this.texts[0] = new FittedText("", textStyles.parse('wheelBonusValues'));
        this.texts[1] = new FittedText("", textStyles.parse('wheelBonusValuesGradient'));
        this.texts[0].anchor.set(0.8, 0.6);
        this.texts[1].anchor.set(0.8, 0.6);
        this.texts[0].maxWidth = 220;
        this.texts[1].maxWidth = 220;
    ...
    setupWin() {
      ...
      if (this.type === 'outer') {
        this.winTexts[0] = new FittedText(this.texts[0].text, textStyles.parse('wheelBonusMultiplierValues'));
        this.winTexts[1] = new FittedText(this.texts[0].text, textStyles.parse('wheelBonusMultiplierValues'));
      } else {
        //text 1
        this.winTexts[0] = new FittedText(this.texts[0].text, textStyles.parse('wheelBonusValues'));
        this.winTexts[1] = new FittedText(this.texts[0].text, textStyles.parse('wheelBonusValuesGradient'));

        //text 2
        this.winTexts[2] = new FittedText(this.texts[0].text, textStyles.parse('wheelBonusValues'));
        this.winTexts[3] = new FittedText(this.texts[0].text, textStyles.parse('wheelBonusValuesGradient'));
      }

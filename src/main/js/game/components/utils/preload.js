define(require => {
    ...
    function preload(app, callback) {
        ...
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements5.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements6.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements7.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements8.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements9.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements10.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements11.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements12.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BG_elements_atlas_page_BG_elements13.jpg']);
        ...
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BonusBG_atlas_page_BonusBG2.jpg']);
        ...
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['Bonuses_atlas_page_Bonuses2.png']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['Bonuses_atlas_page_Bonuses3.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['Bonuses_atlas_page_Bonuses3.png']);
        ...
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['Bonuses_atlas_page_Bonuses15.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['Bonuses_atlas_page_Bonuses16.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['Bonuses_atlas_page_Bonuses17.jpg']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['BonusTriggers_atlas_page_BonusTriggers.jpg']);
        ...
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['CoverAnims_atlas_page_CoverAnims4.png']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['GoldNumbers_atlas_page_GoldNumbers.png']);
        app.renderer.plugins.prepare.add(PIXI.utils.BaseTextureCache['GoldNumbers_atlas_page_GoldNumbers.jpg']);
        ...
        displayList.buyButton.hitArea = new PIXI.Rectangle(-120,-40,238,75);
        displayList.tryButton.hitArea = new PIXI.Rectangle(-120,-40,238,75);
        displayList.playAgainButton.hitArea = new PIXI.Rectangle(-120,-40,238,75);
        displayList.tryAgainButton.hitArea = new PIXI.Rectangle(-120,-40,238,75);
    }
